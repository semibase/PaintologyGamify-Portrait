package com.paintology.lite.portrait.drawing.Activity.gallery_activity.views.activities
...
import com.paintology.lite.portrait.drawing.Activity.Lists.challengeLevelList
import com.paintology.lite.portrait.drawing.Activity.favourite.DrawingRepository
import com.paintology.lite.portrait.drawing.Activity.gallery_activity.adapter.CommentsAdapter
import com.paintology.lite.portrait.drawing.Activity.gallery_activity.adapter.TagAdapter
import com.paintology.lite.portrait.drawing.Activity.gallery_activity.model.Comment
...
import com.paintology.lite.portrait.drawing.Activity.utils.Constants_Gallery
import com.paintology.lite.portrait.drawing.Activity.utils.getUserOnlineStatus
import com.paintology.lite.portrait.drawing.Activity.utils.getUserProfileData
import com.paintology.lite.portrait.drawing.Activity.utils.hide
import com.paintology.lite.portrait.drawing.Activity.utils.hideKeyboard
import com.paintology.lite.portrait.drawing.Activity.utils.invisible
import com.paintology.lite.portrait.drawing.Activity.utils.onSingleClick
import com.paintology.lite.portrait.drawing.Activity.utils.onSingleClick1
import com.paintology.lite.portrait.drawing.Activity.utils.openActivity
import com.paintology.lite.portrait.drawing.Activity.utils.show
import com.paintology.lite.portrait.drawing.Activity.utils.showPopupMenu
import com.paintology.lite.portrait.drawing.Activity.utils.showToastRelease
import com.paintology.lite.portrait.drawing.Activity.utils.startDrawingActivity
import com.paintology.lite.portrait.drawing.Activity.utils.startDrawingActivityWithRank
...
import com.paintology.lite.portrait.drawing.challenge.ChallengeLevelsModel
import com.paintology.lite.portrait.drawing.challenge.adapter.ChallengeLevelsAdapter
import com.paintology.lite.portrait.drawing.challenge.adapter.LevelClick
import com.paintology.lite.portrait.drawing.data.db.FirebaseFirestoreApi
import com.paintology.lite.portrait.drawing.data.db.FirebaseFirestoreApi.countDrawingView
import com.paintology.lite.portrait.drawing.databinding.ActivityDrawingViewBinding
import com.paintology.lite.portrait.drawing.databinding.LayoutBottomSheetChallengeBinding
                ...
                imgMenuDrawing.showPopupMenu(R.menu.drawing_screen_menu) {
                    ...
                    when (it.itemId) {
                        ...
                        R.id.addFav -> {
                            ...
                            val newDraw:com.paintology.lite.portrait.drawing.Activity.favourite.NewDrawing =
                                com.paintology.lite.portrait.drawing.Activity.favourite.NewDrawing(
                                    model.author,
                                    model.createdAt,
                                    model.description,
                                    model.id,
