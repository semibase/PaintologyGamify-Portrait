package com.paintology.lite.portrait.drawing.Activity.notifications.ui.activities;
...
import com.paintology.lite.portrait.drawing.Activity.notifications.adapter.BaseViewHolderCommunityNotification;
import com.paintology.lite.portrait.drawing.Activity.notifications.models.CommunityPostNotification;
import com.paintology.lite.portrait.drawing.Adapter.CommunityPostAdapter;
...
public class CommunityPostViewNotification extends BaseViewHolderCommunityNotification implements View.OnClickListener {
...
//    ImageView tv_do_tutorial;
    ...
    private CommunityPostNotification object;

    public CommunityPostViewNotification(View view, PostOperation _interface, Context context, home_fragment_operation _interface_home, boolean... FromProfileScreen) {
        super(view);
...
//        tv_do_tutorial.setOnClickListener(this);
        ...
        iv_post_comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    System.out.println("Post ID: " + object.getPostId());
                    String number = String.valueOf(object.getPostId());
...
//        snackbar.show();
    ...
    @Override
    public void onBindView(CommunityPostNotification object) {
        this.object = object;
...
//            edt_enter_tag.setVisibility(View.GONE);
            ...
            if (object != null) {
                ...
                if (object.getLegacyData() != null) {
                    isTypeTutorial = object.getLegacyData().getPostType();
                }
...
//                    tv_do_tutorial.setVisibility(View.GONE);
                    ...
                    if (object.getCreatedAt() != null) {
                        String time = convertTimestampToLocal(object.getCreatedAt().toString());
...
//                    System.out.println("HashTag " + object.getDescription() + " " + tags);
                    System.out.println("Post_id" + object.getPostId());
...
//                    myViewHolder.tv_cmnt_1.setText(_userPostList.getObjData().getPost_list().get(i).getCommentsList().getPost_comment_lists().get(0).getComment_content());
    ...
    void showDialog(boolean isVisible, CommunityPost _object, View view) {
        ...
        try {
            ...
            if (object.getLinks() != null) {
                if (object.getLinks().getYoutube() != null && !object.getLinks().getYoutube().isEmpty()) {
                    ...
                    items = new CharSequence[]{"More Details", "Share", "Copy Link", "Open in Canvas (overlay)", "Open in Canvas (trace)", "Posts by " + object.getAuthor().getName(), "Chat", "Download", "Report"};
                    item_option = new CharSequence[]{"Share", "Copy Link", "Open in Canvas (overlay)", "Open in Canvas (trace)", "Posts by " + object.getAuthor().getName(), "Chat", "Download", "Report"};
                    ...
                    case R.id.chat:
                        try {
                            ...
                            if (AppUtils.isLoggedIn()) {
                                ...
                                Toast.makeText(_context, constants.open_social_login_community, Toast.LENGTH_SHORT).show();
