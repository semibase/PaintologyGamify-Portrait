...
public class ShowCommunityListAdapter extends RecyclerView.Adapter<BaseViewHolder> implements notifyPostList {
    ...
    public ShowCommunityListAdapter(UserPostFromApi _userPostList, Context _context, home_fragment_operation _interface, PostOperation post_interface, boolean... FromProfileScreen) {
