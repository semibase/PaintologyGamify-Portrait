...
import com.paintology.lite.portrait.drawing.Model.Views;
...
import com.paintology.lite.portrait.drawing.util.notifyPostList;
 ...
 */
public class ShowCommunitySinglePostAdapter extends RecyclerView.Adapter<BaseViewHolder> implements notifyPostList {
    ...
    public ShowCommunitySinglePostAdapter(UserSinglePostFromApi _userPostList, Context _context, home_fragment_operation _interface, PostOperation post_interface, boolean... FromProfileScreen) {
...
//        }
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        holder.onBindView(_userPostList.getObjData().getPost_list().get(holder.getAdapterPosition()));
