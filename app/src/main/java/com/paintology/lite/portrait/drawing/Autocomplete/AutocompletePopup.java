package com.paintology.lite.portrait.drawing.Autocomplete;
    ...
    private int buildDropDown() {
        ...
        switch (mWidth) {
            case ViewGroup.LayoutParams.WRAP_CONTENT:
                childWidthSpec = View.MeasureSpec.makeMeasureSpec(maxContentWidth, View.MeasureSpec.AT_MOST);
                break;
            case ViewGroup.LayoutParams.MATCH_PARENT:
                childWidthSpec = View.MeasureSpec.makeMeasureSpec(maxContentWidth, View.MeasureSpec.EXACTLY);
                break;
            default:
                //noinspection Range
                childWidthSpec = View.MeasureSpec.makeMeasureSpec(mWidth, View.MeasureSpec.EXACTLY);
                break;
        }
