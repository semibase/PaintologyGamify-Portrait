...
package com.paintology.lite.portrait.drawing.CameraPreview.CustomCropper;
...
public final class CropImage {
     ...
     */
    public static void startPickImageActivity(@NonNull AppCompatActivity activity) {
        activity.startActivityForResult(
                getPickImageChooserIntent(activity), PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }

    /**
     * Same as {@link #startPickImageActivity(AppCompatActivity) startPickImageActivity} method but instead of
     ...
     * Result will be received in {@link AppCompatActivity#//onActivityResult(int, int, Intent)} and can be
     ...
     * #activity(Uri)}.
     *
     * @param data result data intent as received in {@link AppCompatActivity#//onActivityResult(int, int,
     *             Intent)}.
