package com.paintology.lite.portrait.drawing.CameraPreview.manager.impl;
...
import com.paintology.lite.portrait.drawing.CameraPreview.manager.listener.CameraCloseListener;
import com.paintology.lite.portrait.drawing.CameraPreview.manager.listener.CameraOpenListener;
import com.paintology.lite.portrait.drawing.CameraPreview.manager.listener.CameraPhotoListener;
import com.paintology.lite.portrait.drawing.CameraPreview.manager.listener.CameraVideoListener;
import com.paintology.lite.portrait.drawing.CameraPreview.utils.CameraHelper;
...
public class Camera1Manager extends BaseCameraManager<Integer, SurfaceHolder.Callback>
                ...
                try {
                    ...
                    if (cameraOpenListener != null) {
                        uiHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                Log.e("TAGGG", "Exception while configureTransform openCamera 33> " + previewSize.getWidth() + " >H> " + previewSize.getHeight());
    ...
    public void closeCamera(final CameraCloseListener<Integer> cameraCloseListener) {
        try {
            ...
            Log.e("TAG", "Exception at closeCamera " + e.getMessage());
        }
    ...
    protected void prepareCameraOutputs() {
        try {
            ...
            if (configurationProvider.getMediaAction() == CameraConfiguration.MEDIA_ACTION_PHOTO
                ...
                Log.e("TAGGG", "View Height Width Print PRE 1> " + photoSize.getWidth() + " <H> " + photoSize.getHeight());
                previewSize = CameraHelper.getSizeWithClosestRatio(previewSizes, photoSize.getWidth(), photoSize.getHeight());
            } else {
                Log.e("TAGGG", "View Height Width Print PRE 2> " + videoSize.getWidth() + " <H> " + videoSize.getHeight());
                previewSize = CameraHelper.getSizeWithClosestRatio(previewSizes, videoSize.getWidth(), videoSize.getHeight());
            }
            Log.e("TAGGG", "View Height Width Print PRE> " + previewSize.getWidth() + " >H> " + previewSize.getHeight());
        } catch (Exception e) {
