...
import com.paintology.lite.portrait.drawing.CameraPreview.utils.ImageSaver;
                ...
                uiHandler.post(new Runnable() {
                    ...
                    public void run() {
                        if (!TextUtils.isEmpty(currentCameraId) && previewSize != null && currentInstance != null) {
                            Log.e("TAGGG", "Exception while configureTransform openCamera 44> " + previewSize.getWidth() + " >H> " + previewSize.getHeight());
