package com.paintology.lite.portrait.drawing.CircleProgress;
...
public class CircleProgressBar extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mProgressColor1 = getResources().getColor(R.color.gray_color);
        mProgressColor2 = getResources().getColor(R.color.colorAccent);
        mProgressColor3 = getResources().getColor(R.color.colorPrimaryDark);
        mProgressColor4 = getResources().getColor(R.color.com_facebook_blue);

        mColors = new int[]{mProgressColor, mProgressColor1, mProgressColor2, mProgressColor3, mProgressColor4};
