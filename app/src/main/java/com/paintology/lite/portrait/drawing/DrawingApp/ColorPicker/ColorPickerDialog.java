package com.paintology.lite.portrait.drawing.DrawingApp.ColorPicker;
...
public class ColorPickerDialog extends AlertDialog {
    ...
    public ColorPickerDialog(Context context, int initialColor, OnColorSelectedListener onColorSelectedListener) {
        ...
        setButton(BUTTON_POSITIVE, context.getResources().getString(android.R.string.ok), onClickListener);
        setButton(BUTTON_NEGATIVE, context.getResources().getString(android.R.string.cancel), onClickListener);
