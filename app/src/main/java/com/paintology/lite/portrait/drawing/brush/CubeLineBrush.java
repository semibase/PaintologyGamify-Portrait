package com.paintology.lite.portrait.drawing.brush;
...
public class CubeLineBrush extends Brush {
    private String TAG;
    private Random mRandom;

    StringConstants _constant = new StringConstants();

    public CubeLineBrush() {
...
//        Log.e(TAG, "Prepare Paint called mBrushSize " + mBrushSize);
        ...
        if (lPaint5 == null) {
            ...
            lPaint5.setStrokeWidth(mBrushSize + 5.0f);
            lPaint5.setFilterBitmap(true);
            Path p = new Path();
            p.addRect(0, 0, mBrushSize, mBrushSize, Path.Direction.CW);
//            lPaint5.setPathEffect(new PathDashPathEffect(p, 12, 1, PathDashPathEffect.Style.TRANSLATE));


            lPaint5.setPathEffect(new PathDashPathEffect(p, 12, 2, PathDashPathEffect.Style.TRANSLATE));
        }
    }
