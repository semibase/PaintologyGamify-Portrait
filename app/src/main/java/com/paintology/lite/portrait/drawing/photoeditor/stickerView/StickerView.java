package com.paintology.lite.portrait.drawing.photoeditor.stickerView;
...
public class StickerView extends ImageView {
    ...
    public StickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDeleteIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.ic_sticker_close));
        mZoomIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.ic_sticker_rotate));
        mFlipIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.ic_sticker_reversal_horizontal));
    }
