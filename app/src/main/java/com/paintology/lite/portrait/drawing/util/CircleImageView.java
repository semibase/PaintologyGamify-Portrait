...
//    private final ScaleType SCALE_TYPE = ScaleType.CENTER_CROP;
    ...
    private final int DEFAULT_CIRCLE_BACKGROUND_COLOR = Color.TRANSPARENT;
    ...
    public CircleImageView(Context context) {
        ...
        try {
            ...
            Log.e("TAG", "Exception at CircleImageView " + e.getMessage());
        }
    }
...
//        super.setScaleType(SCALE_TYPE);
   ...
   /* @Override
    ...
    private void applyColorFilter() {
        try {
            if (mBitmapPaint != null && mColorFilter != null)
